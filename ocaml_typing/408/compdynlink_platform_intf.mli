...
module type S = sig
  ...
  val adapt_filename : Compdynlink_types.filename -> Compdynlink_types.filename
  ...
  val fold_initial_units
    ...
    -> f:('a
      ...
      -> implementation:(Digest.t option * Compdynlink_types.implem_state) option
      -> defined_symbols:string list
      -> 'a)
    -> 'a

  val load
     : filename:Compdynlink_types.filename
    -> priv:bool
