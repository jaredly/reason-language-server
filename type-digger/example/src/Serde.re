...
module Version7 = {
  ...
  and migrate_Types____named:
    'a 'a_migrated . ('a => 'a_migrated, Version6._Types__named('a)) =>
    _Types__named('a_migrated) =
    (_migrator_a, _input_data) => {
      name: _input_data.name,
      contents: _migrator_a(_input_data.contents),
      isClosed: _input_data.isClosed
    }
  ...
  and migrate_Types____what:
    'a 'a_migrated . ('a => 'a_migrated, Version6._Types__what('a)) =>
